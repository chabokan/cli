...
@chabokan.net/cli/0.7.5 darwin-x64 node-v14.17.5
$ chabok --help [COMMAND]
USAGE
  $ chabok COMMAND
...
...
_See code: [src/commands/change-user.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/change-user.ts)_
...
_See code: [src/commands/config-clear.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/config-clear.ts)_
...
_See code: [src/commands/deploy.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/deploy.ts)_
...
_See code: [src/commands/login.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/login.ts)_
...
_See code: [src/commands/logs.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/logs.ts)_
...
_See code: [src/commands/resize.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/resize.ts)_
...
_See code: [src/commands/restart.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/restart.ts)_
...
_See code: [src/commands/start.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/start.ts)_
...
_See code: [src/commands/stop.ts](https://github.com/chabokan/cli/blob/v0.7.5/src/commands/stop.ts)_
<!-- commandsstop -->
